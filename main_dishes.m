...
for j = 1:100
    ...
    [beta_est_full{j}, alpha_est_full{j}, theta_est_full{j}, subgroup_est{j}, timecost_full(j)] = dishes(X_full{j}, Z_full{j}, Y_full{j}, 0.01, theta_U, W, Sigma_big);
...
fclose(file);
save(sprintf('results/Case%d_dishes.mat', case_number), 'beta_full', 'alpha_full', 'theta_full', 'S_est_full','timecost_full','NMI_full','perfect_full','subgroup_est', '-v7.3');
clear -regexp *_full;
end
